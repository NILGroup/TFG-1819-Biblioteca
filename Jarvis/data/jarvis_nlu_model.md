...
- Quiero un libro llamado [Narnia la travesía del viajero del alba](libro_titulo)
- Me podrías decir un libro llamado [Luces de bohemia](libro_titulo)
- Dime libro titulado [Mortadelo y Filemón](libro_titulo)
- Dime un libro titulado [Mortadelo y Filemón](libro_titulo)
- Dime un libro llamado [Mortadelo y Filemón](libro_titulo)
- Necesito una obra literaria llamada [Lo que el viento se llevó](libro_titulo)
- Busca una obras literaria llamada [1984](libro_titulo)
...
- Busco libros llamados [Narnia](libro_titulo)
- Quiero libros titulado [Yo, Julia](libro_titulo)
- Quiero libros llamados [Narnia la travesía del viajero del alba](libro_titulo)
- Me podrías decir algún libro llamado [Luces de bohemia](libro_titulo)
- Dime libros titulados [Mortadelo y Filemón](libro_titulo)
- Dime algún libro titulado [Mortadelo y Filemón](libro_titulo)
- Dime algún libro llamado [Mortadelo y Filemón](libro_titulo)
- Necesito obras literarias llamadas [Lo que el viento se llevó](libro_titulo)
- Busca obras literarias llamadas [1984](libro_titulo)
- Necesito libros titulados [Preludio a la fundación](libro_titulo)
- Libros llamados [Juego de Tronos](libro_titulo)
