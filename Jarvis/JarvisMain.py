...
class jarvisService():
    ...
    def do_petition():
        ...
        procesador = JarvisProcessor.JarvisProcessor()
        analisis = procesador.procesarPeticion(post_data["content"])
        respuesta = procesador.formatearResultado(analisis)
...
def initialize():
    tmp = JarvisProcessor.JarvisProcessor()
